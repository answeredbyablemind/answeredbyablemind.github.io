...
[고윳값과 고유벡터의 기하학적 의미](https://angeloyeo.github.io/2019/07/17/eigen_vector.html) 편에서는 고윳값과 고유벡터를 다음과 같이 생각하자고 하였다.
...
스케일링이란 [벡터의 기본 연산(상수배, 덧셈)](https://angeloyeo.github.io/2020/09/07/basic_vector_operation.html) 편에서 다룬 것과 같이 벡터로써 갖추어야 할 기본적인 성질이다.
