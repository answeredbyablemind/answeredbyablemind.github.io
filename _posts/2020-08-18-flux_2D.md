...
<p align = "center">
  <img width = "700" src = "https://raw.githubusercontent.com/angeloyeo/angeloyeo.github.io/master/pics/2020-08-18-flux_2D/pic4.png">
  <br>
...
아래 그림과 같이 법선 벡터는 접선 벡터를 -90도 회전 시켜줌으로써 얻을 수 있다.

<p align = "center">
  <img width = "700" src = "https://raw.githubusercontent.com/angeloyeo/angeloyeo.github.io/master/pics/2020-08-18-flux_2D/pic5.png">
  <br>
  그림 5. 접선벡터와 법선벡터의 관계
</p>
...
이므로, 임의의 벡터 $\begin{bmatrix}x\\y\end{bmatrix}$에 대해 위의 회전행렬을 적용하면,
...
임을 알 수 있다. 즉, 어떤 벡터를 -90도 회전시켜주려면 벡터의 두 컴포넌트를 바꿔주고 $y$ 컴포넌트에 -1을 곱해주면 되는 것이다.
