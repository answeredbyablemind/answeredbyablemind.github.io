...
$$\frac{\partial}{\partial \theta}L(\theta|x) = \frac{\partial}{\partial \theta}log P(x|\theta) = \sum_{i=1}^{n}\frac{\partial}{\partial\theta}logP(x_i|\theta) = 0 $$
...
이다. 따라서 $L^*(\theta)$를 에 대해 편미분하면,

<center><img src="http://bit.ly/2kGmTvL">

<img src="http://bit.ly/2kGsl1x"> </center>


따라서 최대우도를 만들어주는 모평균의 추정량은

<center><img src="http://bit.ly/2kGsF0a"></center>

이다.

한편, $L^*(\theta)$를 표준편차 $\sigma$로 편미분하면

<center>

<img src="http://bit.ly/2kTlVHr">

<img src="http://bit.ly/2kGlLYQ">

<img src="http://bit.ly/2kTm4ut">

</center>

따라서, 최대우도를 만들어주는 모분산의 추정량은

<center><img src="http://bit.ly/2kTbfss"></center>
