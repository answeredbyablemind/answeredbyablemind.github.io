...
$$\frac{\partial L(\theta|x)}{\partial \sigma} 

= -\frac{n}{\sigma} - \frac{1}{2}\sum_{i=1}^{n}\left(x_i-\mu\right)^2\frac{\partial}{\partial\sigma}\left(\frac{1}{\sigma^2}\right)$$

$$=-\frac{n}{\sigma}+\frac{1}{2}\sum_{i=1}^{n}(x_i-\mu)^2\cdot 2 \frac{1}{\sigma}\left(-\frac{1}{\sigma^2}\right)$$
