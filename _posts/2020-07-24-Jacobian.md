...
예시 2는 cartesian coordinate에서 polar coordinate으로 변형되는 비선형변환이다.

$$ f(x,y) = \begin{bmatrix} x\cos(y) \\ x\sin(y)\end{bmatrix}$$

<iframe width = "300" height = "300" src="https://angeloyeo.github.io/p5/2020-07-24-Jacobian_nonlinear_transform/example2" frameborder = "0"></iframe>

### 비선형 변환 예시 3

$$ f(x,y) = \begin{bmatrix} x + y^2 \\ y + e^x \end{bmatrix}$$

<iframe width = "300" height = "300" src="https://angeloyeo.github.io/p5/2020-07-24-Jacobian_nonlinear_transform/example3" frameborder = "0"></iframe>
