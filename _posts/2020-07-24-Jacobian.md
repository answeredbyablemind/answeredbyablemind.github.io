...
<p align = "center">
  ...
  <br> 그림 3. 비선형 변환을 국소적으로 관찰하면 선형변환으로 근사시켜 생각할 수 있다.
</p>

그러면 어떤 선형변환 $J = \begin{bmatrix} a & b \\ c & d \end{bmatrix}$에 의해서 $du$와 $dv$는 $dx$와 $dy$로 변환된다고 볼 수 있다.

수식으로 나타내면 다음과 같다.

$$\begin{bmatrix} dx \\ dy \end{bmatrix} = \begin{bmatrix} a & b \\ c & d \end{bmatrix} \begin{bmatrix} du \\ dv \end{bmatrix}$$
