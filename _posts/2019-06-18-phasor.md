...
> 정답: 복소수 표현방법으로 표기하자면 $V=-j$이고, polar coordinate representation으로 표기하면 $1\angle -90$도이다.


>예3) $v(t)=-cos2\pi ft+0.5sin2\pi ft$를 복소수 표현법과 polar coordinate representation으로 표기하시오.

> 정답: 복소수 표현방법으로 표기하자면 $V=-1-0.5j$이고, polar coordinate representation으로 표기하자면 $1.12\angle -153$도이다. 주의할 점은 $V=X+jY$는 $v(t)=Xcos2\pi ft-Ysin2\pi ft$와 같다는 점이다. 
