...
식 (5)와 식 (6)은 모두 성장에 관한 레시피이다. 왜냐면 좌변에는 성장률이, 우변에는 그 성장량을 기술할 다항식이 적혀있기 때문이다.
...
즉, 식 (5)는 현재 값에서 다음 값으로 넘어갈 때시간에 따른 성장률의 변화가 적용되는 레시피이고, 식 (6) 은 되먹임에 따른 성장률의 변화가 적용되는 레시피라고 할 수 있다.
