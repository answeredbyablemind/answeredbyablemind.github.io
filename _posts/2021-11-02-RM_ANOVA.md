...
앞서 공부한 방식을 그대로 이용하기 위해 그룹 내 분산 $s^2_\text{wit}$와 그룹 간 분산 $s^2_\text{bet}$을 Sum of Squares를 이용해 계산하자.

먼저 $s^2_\text{wit}$을 계산해보자.
...
$$= 7\times \left((4.9571-4.9786)^2+(5.2286-4.9786)^2 +(4.9286-4.9786)^2 + (4.8000-4.9786)^2\right)=0.6814$$
