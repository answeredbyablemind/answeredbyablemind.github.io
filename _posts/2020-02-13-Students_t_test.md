...
사실 그림 3에서와 같은 샘플 추출 과정은 100번이 아니라 거의 무한하다 싶을 정도로 많은 경우의 수가 있을 수 있는데, 모집단의 수가 150이고 n=10인 표본 집단 두 개를 뽑는다고 했을 때 가능한 경우의 수는

$$_{150}C_{20} = 3,631,412,949,318,767,019,908,655\notag$$
