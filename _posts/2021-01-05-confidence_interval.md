...
이로써 왜 100% 신뢰 수준이라는 말을 쓰지 않는지도 알 수 있다. 100% 신뢰 수준을 갖기 위해서는 신뢰 구간이 전체 실선(real number line)이 되어야 하기 때문이다. 신뢰 수준이 100%라는 말은 어떤 추정에 대해 다음과 같이 말하는 것이라고도 할 수 있다.
