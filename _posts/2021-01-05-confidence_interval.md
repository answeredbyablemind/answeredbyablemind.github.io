...
이전 [t-value의 의미와 스튜던트의 t-test](https://angeloyeo.github.io/2020/02/13/Students_t_test.html)편에서 t-value에 대해 정의한 적이 있으며 아래와 같았다.
...
앞서 우리는 표본 평균의 개념을 생각할 때 모평균의 개념의 개념을 함께 생각해봄으로써 신뢰구간의 정의를 이끌어냈다.

여기서도 마찬가지로 t-value에 대해 생각할 때 모평균의 개념을 다시 한번 생각해줌으로써 표본 집단 비교 시 신뢰구간의 개념을 적용할 수 있을 것이다.

두 표본 집단 비교 시 모평균의 개념을 도입해준다는 것은 두 표본이 서로 다른 모평균을 갖는 집단에서 추출되었다고 새롭게 가정함으로써 출발할 수 있다.
