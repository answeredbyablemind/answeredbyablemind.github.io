...
그림 1에서처럼 세 개의 표본 집단이 주어져있다고 생각해보자. 세 개의 표본 집단의 평균을 비교하려고 하면 총 세 번의 비교가 이루어져야한다. 세 개 중 두 개를 고르는 방법은 세가지이기 때문이다.
...
<p align = "center">
    ...
    그림 1. 세 표본 집단들의 평균을 비교하기 위해선 각 표본의 평균값을 비교해 보아야 한다.
</p>

이번엔 그림 2처럼 세 개의 표본 집단이 주어져있다고 생각해보자.

이번 그림 2의 표본 집단들은 봤을 때 서로 차이를 보인다고 하기 어려워 보이기도 한다. 왜 일까? 사실 그림 2의 표본들의 평균은 그림 1의 표본들의 평균과 같게 설정되어 있다. 그렇지만, 각 표본들의 표본 내 분산값들이 커진채로 주어지다보니 표본의 차이가 있다고 말하기 어려워보이는 것이다. 다시 말해, 표본 내의 퍼진 정도, 즉, 표본 내 분산은 작을수록 세 집단은 차이를 보인다고 말할 수 있을 것이다.
...
지금까지 그림 1, 그림 2에서 확인한 논의를 요약하자면, 표본간 분산은 클 수록 좋고 표본 내 분산은 작을 수록 세 집단이 차이를 보인다고 할 수 있다.
