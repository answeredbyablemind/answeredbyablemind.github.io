...
function plotDotRight() {
     ...
     fill(252, 73, 3);
     noStroke();
     translate(3 / 4 * width, height + 30/800 * width);
...
function plotDotLeft() {
     push();
     translate(50/ 800 * width, height + 30/800 * width);
     scale(1, -1);
     fill(252, 73, 3);
     noStroke();
     ellipseMode(CENTER);
...
function plotAxes() {
     ...
     line((50 - 10)/ 800 * width, height + 30/800 * width, width / 2 - 20/ 800 * width, height + 30/800 * width);
     pop();

     push();
     stroke(255);
     translate(width / 2 - 20/ 800 * width, height + 30/800 * width);
     rotate(-PI / 2);
