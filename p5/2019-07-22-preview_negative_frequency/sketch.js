...
function plotDotRight() {
     ...
     fill(252, 73, 3);
     noStroke();
     translate(3 / 4 * width, (height + 50 / 800 * width)/2);
...
function plotDotLeft() {
     push();
     translate(50/ 800 * width, (height + 50 / 800 * width)/2);
     scale(1, -1);
     fill(252, 73, 3);
     noStroke();
     ellipseMode(CENTER);
...
function plotAxes() {
     ...
     line((50 - 10)/ 800 * width, (height + 50 / 800 * width)/2, width / 2 - 20/ 800 * width, (height + 50 / 800 * width)/2);
     pop();

     push();
     stroke(255);
     translate(width / 2 - 20/ 800 * width, (height + 50 / 800 * width)/2);
     rotate(-PI / 2);
